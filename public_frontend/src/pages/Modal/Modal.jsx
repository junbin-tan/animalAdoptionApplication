...
const Modal = ({ setShowModal, description, animalListing }) => {
  ...
  return (
    <>
      ...
      {currentActualUser &&
        currentActualUser.accountStatus === "UNVERIFIED" && (
          <>
            <div className="modal__wrapper_animallisting">
              <div className="single__modal_animallisting">
                <span className="close__modal_animallisting">
                ...
                <h2 className="text-center text-light">Your Account Status</h2>
                <h6 className="text-center text-light">
                  Please wait for the Admin to verify your account before you
                  can adopt/foster pets. Thank you.
                </h6>
              </div>
            </div>
          </>
      ...
      {currentActualUser &&
        currentActualUser.accountStatus === "VERIFIED" &&
        currentActualUser.email === animalListing.member.email && (
          <>
            <div className="modal__wrapper_animallisting">
              <div className="single__modal_animallisting">
                <span className="close__modal_animallisting">
                ...
                <h6 className="text-center text-light">
                  <p>
                    You are not allowed to submit an application form for your
                    own animal listing.{" "}
                  </p>
                  <p>
                    We know you are excited about your pets receiving new loves,
                    so please click the button below to view the application
                    forms submitted for your animal listing.
                  </p>
                </h6>
                <Toast ref={toast} />
                <div className="form-demo">
                      ...
                      <form onSubmit={formik.handleSubmit} className="p-fluid">
                        ...
                        <div className="field-checkbox">
                          ...
                          <label
                            ...
                            style={{ color: "black" }}
                          >
                            Is this your first time owning a pet? (Tick for
                            true)
                          </label>
                        </div>
